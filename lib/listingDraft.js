...
const LEASE_VALUES = invertLabels(LEASE_LABELS);
const ROOM_TYPE_VALUES = invertLabels(ROOM_TYPE_LABELS);
const KEYDETAIL_VALUES = invertLabels(KEYDETAIL_LABELS);
const LOOKINGFOR_VALUES = invertLabels(LOOKINGFOR_LABELS);
...
// Age in years from the signup dob format 'MM/DD/YYYY'. Null when missing/unparsable.
